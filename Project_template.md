...
[Диаграмма контейнеров](documentation/container.puml)
...
![kafka](tasks/task2_kafka.png)
![tests](tasks/task2_tests.png)
...
![api](tasks/task3_api.png)
![tests](tasks/task3_kuber_tests.png)
...
![helm](tasks/task4_helm.png)
![curl](tasks/task4_curl.png)
